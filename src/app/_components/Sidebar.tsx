    ...
    <div key={i} onChange={setSelectedCategory}>
      ...
      <label className="flex-col flex-1 overflow-y-auto border-b border-white/20" htmlFor={category.toString()}>
        <div className="flex flex-col gap-2 pb-2 text-gray-100 text-sm">
          <a className={"flex py-3 px-3 items-center gap-3 relative rounded-md hover:bg-[#2A2B32] cursor-pointer break-all hover:pr-4 group " + (category.toString() === selectedCategory.value ? "bg-[#2A2B32]" : '')}>
